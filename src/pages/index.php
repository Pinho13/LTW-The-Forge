...
drawHeader([
    '../style/components/terminal-box.css',
    '../style/components/plans.css',
    '../style/index.css'
], $session);
?>

<section id="about" class="hero-content">
    <div class="hero">
...
<section class="platform-overview">
    ...
    <p
        class="terminal-text"
        data-text="A complete gym management platform where members can explore classes, follow their progress, and manage their account, while trainers and administrators handle scheduling and operations."
    ></p>
</section>
...
<section id="facilities" class="photos-container">
    <div class="image left">
        <img
            ...
            alt="Image of the interior of The Forge gym with heavy machinery"
        >
    </div>
    ...
    <div class="image right">
        <img
            src="../assets/images/main-page/right-image.webp"
            alt="Image of the interior of The Forge gym with many people"
        >
    </div>
</section>
